...
describe('Product Gallery (Home Page)', () => {
    ...
    it('should verify that the user can add a product to the cart from the ‘products’ page', () => {
        ...
        cy.get(cartPage.getProductCardData(1)[1]).should("contain", `$${cartPage.numberWithCommas(product1.quantity * product1.price)}.00`) // check product price
        ...
        cartPage.closeCart()
        cy.get(homePage.cartButton).should("have.text", `$${cartPage.numberWithCommas(total)}.00`) // check price
    })
    ...
    it('should verify that the user can add multiple of the same product to cart', () => {
        ...
        // assert that the product is in the cart
        cy.get(cartPage.firstProductCard).should("be.visible")
        cy.get(cartPage.getProductCardData(1)[0]).should("contain", product19.name) // check product name
        cy.get(cartPage.getProductCardData(1)[1]).should("contain", `$${cartPage.numberWithCommas(product19.quantity * product19.price)}.00`) // check product price
        cy.get(cartPage.getProductCardData(1)[2]).should("have.text", `${product19.quantity}`) // check product quantity
        cy.get(cartPage.cartTotal).should("contain", `$${cartPage.numberWithCommas(total)}.00`) // check total

        // close cart and check the price displayed on home page
        cartPage.closeCart()
        cy.get(homePage.cartButton).should("have.text", `$${product19.quantity * product19.price}.00`) // check price
    })
    ...
    it('should verify that the user can add multiple products to the cart from the ‘products’ page', () => {
        ...
        cy.get(cartPage.getProductCardData(2)[1]).should("contain", `$${cartPage.numberWithCommas(product2.price * product2.quantity)}.00`) // check product price
    ...
    it('should verify that the user can add an item to cart from the product’s information page', () => {
        ...
        cy.get(detailsPage.productPrice).should("contain", `$${product1.price}`)
        ...
        cy.get(cartPage.firstProductCard).should("be.visible")
        cy.get(cartPage.getProductCardData(1)[0]).should("contain", product1.name) // check product name
        cy.get(cartPage.getProductCardData(1)[1]).should("contain", `$${product1.quantity * product1.price}.00`) // check product price
        cy.get(cartPage.getProductCardData(1)[2]).should("have.text", `${product1.quantity}`) // check product quantity
        cy.get(cartPage.cartTotal).should("contain", `$${total}.00`) // check total    
    })
    ...
    it('should verify that the user can add add one item to cart from the ‘products’ page and add the same item again from the product’s information page', () => {
        ...
        cy.get(cartPage.getProductCardData(1)[1]).should("contain", `$${product5.quantity * product5.price}.00`) // check product price
        ...
        cy.get(detailsPage.productPrice).should("contain", `$${product5.price}`)
    ...
    it('should verify that the user can search for a product and add it to cart', () => {
        ...
        cy.get(cartPage.getProductCardData(1)[1]).should("contain", `$${product18.price}`) // check product price
    ...
    it('should verify that the user can ause the direct link to the product’s information page and add the product to cart', () => {
        ...
        cy.get(detailsPage.productPrice).should("contain", `$${product3.price}`)
        ...
        cy.get(cartPage.getProductCardData(1)[1]).should("contain", `$${product3.quantity * product3.price}.00`) // check product price
    ...
    it('should verify that the user cannot add a product to cart with blank quantity', () => {
        ...
        cy.get(cartPage.emptyCartError).should("be.visible")
    })
    ...
    it('should verify that the user can only use numeric characters as input for quantity', () => {
        ...
        cy.get(cartPage.getProductCardData(1)[1]).should("contain", `$${cartPage.numberWithCommas(product13.quantity * product13.price)}.00`) // check product price
