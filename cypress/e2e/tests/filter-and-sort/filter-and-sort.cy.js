...
describe('Sort-and-Filter', () => {    
        ...
        let productsList = [
            [product1.name, product1.category, product1.price], [product2.name, product2.category, product2.price],
            [product3.name, product3.category, product3.price], [product4.name, product4.category, product4.price],
            [product5.name, product5.category, product5.price], [product6.name, product6.category, product6.price],
            [product7.name, product7.category, product7.price], [product8.name, product8.category, product8.price],
            [product9.name, product9.category, product9.price], [product10.name, product10.category, product10.price],
            [product11.name, product11.category, product11.price], [product12.name, product12.category, product12.price],
            [product13.name, product13.category, product13.price], [product14.name, product14.category, product14.price],
            [product15.name, product15.category, product15.price], [product16.name, product16.category, product16.price],
            [product17.name, product17.category, product17.price], [product18.name, product18.category, product18.price],
            [product19.name, product19.category, product19.price], [product20.name, product20.category, product20.price],
            [product21.name, product21.category, product21.price], [product22.name, product22.category, product22.price]
        ]
